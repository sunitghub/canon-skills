...
5. Write at least 2 eval test cases in `skills/<name>/evals/evals.json` and run `/skill-eval <name>` to verify. See [standards/skill-setup-std.md → Testing](standards/skill-setup-std.md#testing) for the format and coverage checklist.
