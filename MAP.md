...
| `scripts/` | Lifecycle shell scripts — `auto-handoff.sh` (Stop hook), `handoff-inject.sh` (UserPromptSubmit hook), `gen-starters.sh`, `test.sh` |
...
| `starters/` | Copy-paste starter kit for new projects — portable snapshots of CLAUDE.md, AGENTS.md, standards, skill template |
